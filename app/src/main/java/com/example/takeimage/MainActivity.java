...
import com.example.takeimage.GalleryPhoto;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_gambar_lain = (Button) findViewById(R.id.gambar_lain);
        ...
        if (requestCode== GALLERY){
            if (data !=null){
                ...
                try {
                    ...
                    Toast.makeText(com.example.takeimage.MainActivity.this,"Image Saved !",
                    ...
                    e.printStackTrace();
                    Toast.makeText(com.example.takeimage.MainActivity.this,"Failed!",
                            Toast.LENGTH_SHORT).show();
                }
            }
